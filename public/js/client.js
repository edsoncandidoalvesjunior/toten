...
let recStartTime;
let recElapsedTime;
let mirotalkTheme = 'ghost'; // neon - dark - forest - ghost ...
...
function setButtonsTitle() {
    ...
    // left buttons
    tippy(shareRoomBtn, {
        content: 'Convidar a Pessoa para a Sala',
        placement: 'right-start',
    });
    tippy(audioBtn, {
        content: 'Click para audio OFF',
        placement: 'right-start',
    });
    tippy(videoBtn, {
        content: 'Click para vídeo OFF',
        placement: 'right-start',
    });
    ...
    tippy(leaveRoomBtn, {
        content: 'Finalizar o Atendimento',
        placement: 'right-start',
    });
...
function whoAreYou() {
    ...
    //         // if (!value) return 'Digite o seu nome';
    ...
    myPeerName = '';
    myVideoParagraph.innerHTML = myPeerName + ' (Você)';
...
function welcomeUser() {
    ...
    //     background: swalBackground,
    //     position: 'center',
    //     title: '<strong>Sua chamada ' + myPeerName + '</strong>',
    //     imageAlt: 'mirotalk-welcome',
    //     imageUrl: welcomeImg,
    //     html:
    //         `
    //     <br/>
    //     <p style="color:white;">Bem vindo a reunião.</p>
